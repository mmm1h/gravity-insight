...
gravity census responses --snapshot tmp/codex/gi-respfields/bundle-snapshot.json --routes tmp/codex/gi-respfields/routes.json --raw-dir tmp/codex/gi-respfields/bundle --output src/gravity_sdk/census/data/route-response-fields.json
gravity census apply-responses --responses src/gravity_sdk/census/data/route-response-fields.json --drafts src/gravity_sdk/contracts/drafts
```
