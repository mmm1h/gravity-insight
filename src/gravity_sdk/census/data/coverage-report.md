...
> Generated by `gravity census coverage`. Do not edit by hand.
...
| `accounted_read_candidate` | 352 |
| `accounted_unsupported` | 58 |
| `covered_executable` | 133 |
...
| (a) Found in previously unfetched chunks | 133 |
...
- Families: **48**
- Uncovered reads assigned to a family: **87 / 382 (22.8%)**
...
| --- | ---: | --- |
| 低 | 171 | Flat list/detail with no evident parent dependency |
| 中 | 85 | Parent-resource dependency or structured selector |
...
| `high` | `GET` | `/turbo_engine/api/v1/bytedance/app/list/` | `singleton` | `低` |
...
| `medium` | `POST` | `/turbo_engine/api/v1/bytedance/site/list/v2/` | `singleton` | `低` |
...
| `medium` | `POST` | `/turbo_engine/api/v1/bytedance/asset/text/title/list/` | `singleton` | `中` |
| `medium` | `POST` | `/turbo_engine/api/v1/bytedance/asset/text/title_package/list/` | `singleton` | `中` |
| `medium` | `POST` | `/turbo_engine/api/v1/bytedance/std/asset/text/title/list/` | `singleton` | `中` |
...
| `medium` | `POST` | `/turbo_engine/api/v1/task/ai_trusteeship/conditions_history_list/` | `singleton` | `低` |
| `high` | `GET` | `/turbo_engine/api/v1/task/ai_trusteeship/detail/` | `singleton` | `低` |
| `medium` | `POST` | `/turbo_engine/api/v1/task/ai_trusteeship/history_list/` | `singleton` | `低` |
