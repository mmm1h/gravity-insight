...
from .agent_host_catalog import (
    MAX_CANDIDATES,
...
def _describe_reference(
    ...
    from .agent_catalog import _capability_for_item, _inventory
    from .agent_handoff import apply_workspace_prefix, attach_plan_node, resolve_workspace_path
...
def _selection_envelope(
    ...
    from .agent_discovery_policy import safe_discovery_query
    from .agent_handoff import agent_execution_contract, agent_fallbacks, resolve_workspace_path
