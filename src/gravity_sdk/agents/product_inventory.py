...
from .analysis import analysis_query_spec_inventory
from .app_catalog import app_catalog_capability_inventory
from .app_public_info import app_public_info_capability_inventory
from .monetization_aggregate import monetization_aggregate_capability_inventory
...
from .report_mutation import report_mutation_capability_inventory
from .segment import segment_capability_inventory
from .table_lineage import table_lineage_capability_inventory
from .user_journey import user_journey_capability_inventory
from .custom_metric import custom_metric_capability_inventory
from .metadata_template import metadata_template_capability_inventory
from .saved_analysis_mutation import (
    saved_analysis_mutation_capability_inventory,
)
from .realtime_event import realtime_event_mutation_capability_inventory
...
def canonical_capability_cards(client: Any) -> tuple[dict[str, Any], ...]:
    ...
    from .host_catalog import owner_boundaries
