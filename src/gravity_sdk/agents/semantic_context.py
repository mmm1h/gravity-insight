...
def load_agent_workspace(workspace: Any | None, sources: Any | None) -> Any | None:
    ...
    if workspace is not None:
        return workspace
    from .sources import load_workspace
...
def _product_card(
    ...
    *,
    ...
    if selector.startswith("@"):
        from .batch_sources import snapshot_recipes
...
def _operation_card(
    ...
    from .sources import _operation_card as build_card
