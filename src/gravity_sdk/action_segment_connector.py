...
from .mutation_ownership import OwnershipDecision
...
def execute_segment_update(
    ...
    *,
    ...
    tracking = _WriteTrackingClient(client)
    try:
...
def verified_readback(
    ...
    return {
        ...
        "receipt_references": _deduplicate_references(references),
    }
...
def _deduplicate_references(values: list[Mapping[str, Any]]) -> list[dict[str, str]]:
