...
```powershell
python -m gravity_insight.prober draft --path /turbo_engine/api/v1/bytedance/std/project/material_report/
```
...
```powershell
python -m gravity_insight.prober probe app.monetization_app.list
python -m gravity_insight.prober probe --stable app.list
```
...
```powershell
python -m gravity_insight.prober status
python -m gravity_insight.prober promote --help
python -m gravity_insight.compiler compile --check
```
