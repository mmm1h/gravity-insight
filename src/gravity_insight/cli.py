...
from gravity_insight import json_output, nonempty_cli, runtime
from gravity_insight.cli_limits import (
    agent_limit as _agent_limit,
    operation_limit as _operation_limit,
    concurrency as _concurrency,
    positive_int as _positive_int,
)
from gravity_insight.pagination_cli import (
    DEFAULT_STDOUT_MAX_ITEMS,
    DEFAULT_STDOUT_MAX_PAGES,
    add_pagination_arguments as _add_all_pages,
    page_options as _page_options,
)
from gravity_insight import result_output
from gravity_insight.credential_sanitization import sanitize_credentials as _sanitize_credentials
...
try:
    ...
    from gravity_insight.export_cli import (
        add_export_commands, command_error, dispatch_command,
        output_argument,
    )
    from gravity_insight.export_batch import (
...
from gravity_insight.parents import add_parent_commands, run_parent_command
from gravity_insight.attribution import add_snapshot_command
from gravity_insight.analysis_spec_cli import run_analysis_query_command
from gravity_insight.analysis_query_batch_cli import add_analysis_query_commands
from gravity_insight.segment_spec_cli import add_segment_commands, run_segment_command
from gravity_insight.business_pulse_cli import add_business_pulse_command
from gravity_insight.material_cli import add_material_commands, dispatch_material_command
from gravity_insight.promotion_cli import (
...
from gravity_insight.dashboard_snapshot_cli import add_dashboard_commands
from gravity_insight.saved_analysis_cli import add_saved_analysis_commands
from gravity_insight.multidim_cli import add_multidim_commands, multidim_ndjson_view
from gravity_insight.user_journey_cli import add_user_journey_command
from gravity_insight.metadata_cli import (
    add_metadata_commands,
    run_analysis_metadata,
    run_metadata_command,
)
from gravity_insight.find import (
    add_find_command,
    filter_operations,
    run_find_command,
    run_operation_command,
)
from gravity_insight.find_input import (
...
from gravity_insight.recipe import add_recipe_commands
from gravity_insight.resolver_cli import add_resolver_command
from gravity_insight.agent import DeferredAgentClient, ndjson_metadata, run_agent_command
from gravity_insight.capability_cli import add_deepening_commands
from gravity_insight.read_cli import add_read_command
from gravity_insight.cli_root_commands import add_root_commands, dispatch_root_command
from gravity_insight.plan_cli import add_plan_commands
from gravity_insight.plan_product_cli import dispatch as dispatch_plan
from gravity_insight.doctor_cli import run_doctor
...
def _iter_ndjson_lines(result: Any):
    if isinstance(result, Mapping) and result.get("schema_version") == "gravity.agent-batch.v1":
        from gravity_insight.agents.batch import iter_ndjson_records
