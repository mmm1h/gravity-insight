...
from .catalog_parity import validate_catalog_parity
from .operation_contract import operation_contract_overlay
...
def run_agent_catalog_command(args: Any, client: Any) -> dict[str, Any]:
    ...
    if action == "host":
        from .host_catalog import host_product_catalog
