...
def recognizer_routing_declaration(query: str) -> dict[str, Any]:
    ...
    from .host_catalog import host_selection_upgrade_contract
    from .host_selection import DEFAULT_ROUTING_MODE
...
def select_authoritative_cards(
    ...
    from .capabilities import authoritative_capability_cards
    from .semantic_context import is_semantic_card
...
def capability_gaps_for_page(
    ...
    if operation_fallback_excluded:
        from .discovery_policy import operation_fallback_gap
...
def materialize_candidates(
    ...
    from .operation_contract import materialize_operation_owner_card
