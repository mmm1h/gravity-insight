...
from .app_catalog import APP_CATALOG_SELECTOR
from .app_public_info import APP_PUBLIC_INFO_SELECTOR
from .export import MATERIAL_EXPORT_OPERATION
from .lexical_rescue import indexed_evidence_rescue, query_top_score
from .monetization_aggregate import MONETIZATION_AGGREGATE_SELECTOR
...
def apply_lexical_fallback(
    ...
    *,
    ...
    from .sql_product_gap import registered_sql_product_intent
    ...
    if (
        ...
        from .sql_product_discovery import apply_workspace_sql_owner
...
def _workspace_decision(
    ...
    *,
    ...
    from .batch_sources import snapshot_products, snapshot_recipes
    from .capabilities import composite_capability_inventory
...
def _composite_documents(
    ...
    from .capabilities import composite_capability_cards
...
def _direct_documents(domain: str | None) -> list[LexicalDocument]:
    from .capabilities import analysis_query_spec_cards
...
def _recipe_documents(
    ...
    if domain is not None:
        return []
    from .sources import snapshot_recipe_cards
