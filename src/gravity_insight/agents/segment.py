...
def is_authoritative_direct_card(card: Mapping[str, Any]) -> bool:
    ...
    from .app_public_info import is_authoritative_app_public_info_card
    from .material_asset import is_authoritative_material_asset_card
    from .monetization_aggregate import is_authoritative_monetization_aggregate_card
    from .kanban_mutation import is_kanban_mutation_card
    from .report_mutation import is_report_mutation_card
    from .custom_metric import is_custom_metric_card
    from .metadata_template import is_metadata_template_card
    from .saved_analysis_mutation import is_saved_analysis_mutation_card
    from .realtime_event import is_realtime_event_mutation_card
