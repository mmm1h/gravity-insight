...
def unbound_gap(
    ...
    from .derived_metrics import derived_metric_gap, derived_metric_intent
...
def resolve_derived(
    ...
    *,
    ...
    from .derived_metrics import semantic_derived_card
...
def multiple_gap(query: str, selectors: Sequence[str]) -> dict[str, Any]:
    from .intent_routing import MULTIPLE_INTENTS
