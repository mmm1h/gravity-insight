...
from gravity_insight.support.process_lock import FileLockTimeout, advisory_file_lock


ROOT = PROJECT_ROOT
SECRET_FILES = (".env.gravity.local",)
RELEASE_TAG = "credential-sync"
ASSET_NAME = "gravity-insight-credentials.json"
...
def push() -> dict[str, str]:
    with sync_lock():
        ...
        with tempfile.TemporaryDirectory(prefix="gravity-insight-credentials-") as temp:
