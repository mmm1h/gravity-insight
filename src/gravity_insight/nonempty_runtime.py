...
from gravity_insight import runtime as tool_runtime

from .nonempty_parents import resolve_parents
...
def discover_nonempty(
    ...
    *,
    ...
    parent_values, parent_failures, summaries, parent_dimensions = resolve_parents(
    ...
    base, dimensions, unresolved = _build_plan(
        ...
        parent_failures=parent_failures, parent_dimensions=parent_dimensions,
