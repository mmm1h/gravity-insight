...
def test_bulk_draft_is_conservative_unique_and_auditable(tmp_path: Path) -> None:
...
def test_bulk_draft_preserves_existing_probe_evidence(tmp_path: Path) -> None:
    route = _route(
...
def test_repository_drafts_satisfy_bulk_quality_gate() -> None:
...
def test_repository_drafts_have_complete_availability_tiers() -> None:
