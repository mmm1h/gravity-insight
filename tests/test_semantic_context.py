...
from gravity_insight.workspace_semantic_context import SemanticContextError
...
class SemanticContextTests(unittest.TestCase):
    ...
    def test_workspace_without_semantics_preserves_canonical_agent_bytes(self) -> None:
        ...
        self.assertEqual(
            ...
            # R2-06 adds discovery observations/obligations and floor guidance;
            # comparison against da0ecff6 confirms the candidate bytes are unchanged.
            "ec6fd65516852be91b45fce88ff12652720ca92686ff4908eb4290b35a72bba7",
        )
