...
class PlanBorrowedConcurrencyTests(unittest.TestCase):
    ...
    def test_promotion_21_platform_peak_request_count_and_partial_envelope(self):
        failed = {
            ...
            "baidu": ("permission_unavailable", "PERMISSION_UNAVAILABLE", "caller", False),
            "bilibili": ("unavailable", "NOT_IMPLEMENTED", "caller", False),
        }
        ...
        self.assertEqual((False, "partial", 3, False, "partial"), (
