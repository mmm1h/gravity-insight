...
from gravity_insight.agents.caller_language import (
...
from gravity_insight.agents.lexical_retrieval import (
    ALGORITHM,
    MINIMUM_SCORE,
    registered_documents,
    retrieve_registered_products,
)
from gravity_insight.agents.sql_product_discovery import WORKSPACE_SQL_NAME_ALGORITHM
...
class AgentLexicalRetrievalTests(unittest.TestCase):
    ...
    def test_indirect_workspace_sql_owner_preserves_adjacent_boundaries(self) -> None:
        from gravity_insight.agents import sql_product_gap as sql_gap
    ...
    def test_operation_products_are_indexed_and_negated_reframes_keep_the_positive(self) -> None:
        from gravity_insight.agents.intent_text import affirmative_intent_text
