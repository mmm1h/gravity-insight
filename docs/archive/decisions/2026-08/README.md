...
| 文件 | 主题 |
| --- | --- |
| [goals-and-current-state.md](goals-and-current-state.md) | 目标与现状 |
| [priorities-constraints-and-loss.md](priorities-constraints-and-loss.md) | 优先级、并行约束与能力净损失 |
| [agent-usability-and-cost.md](agent-usability-and-cost.md) | Agent 可用性、调用成本与归因合同 |
| [agent-eval-baseline.md](agent-eval-baseline.md) | Agent 评测基线与留出集 |
| [eval-harness.md](eval-harness.md) | 评测装置与题集 |
| [projection-and-privacy.md](projection-and-privacy.md) | 投影边界与隐私 |
| [monetization-and-non-goals.md](monetization-and-non-goals.md) | 变现聚合与明确不做 |
| [exports-runtime-and-issues.md](exports-runtime-and-issues.md) | 导出、运行时与 Issue 收口 |
| [semantics-errors-and-discovery.md](semantics-errors-and-discovery.md) | 语义层、错误消息与发现 |
| [writes-and-nl-routing.md](writes-and-nl-routing.md) | 写操作范围与自然语言路由 |
| [workspaces-quality-and-settings.md](workspaces-quality-and-settings.md) | 工作区、质量棘轮与设置复核 |
| [governed-writes-and-analysis.md](governed-writes-and-analysis.md) | 受治理写目录与分析 CRUD |
| [semantic-composition.md](semantic-composition.md) | 语义组合与外部 selector |
| [catalog-routing-and-playbooks.md](catalog-routing-and-playbooks.md) | 目录选路与 playbook |
| [contract-truth-pagination-and-d28.md](contract-truth-pagination-and-d28.md) | 合同真实性、分页与 D28 |
| [permissions-campaigns-and-quality.md](permissions-campaigns-and-quality.md) | 权限、投放读语义与质量收口 |
