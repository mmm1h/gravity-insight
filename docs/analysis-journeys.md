...
自定义指标”这一条独立闭环，故 `52 = 44 / 1 / 7` → `53 = 45 / 1 / 7`。operation/stable 为
226 / 217（185 read + 32 governed mutation）；canonical 产品卡先由 45 增为 73，再加 4 张自定义
指标卡得到 77；精确 gap 为 9，安装目录为 `226 + 77 + 9 = 312` 个 selector。
