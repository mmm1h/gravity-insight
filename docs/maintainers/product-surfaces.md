...
| Material Game Performance | `materials game-performance` / `material_game_performance()` / direct `material.game_performance` card | Bounded reports and diagnostic same-ID daily aggregates; user platform scope unproven; no Plan adapter | [CLI](../reference/cli.md#material-game-performance), [SDK](../reference/sdk.md#material-game-performance) |
