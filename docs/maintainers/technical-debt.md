...
## 当前条目
### 缓存缺少持久化退休与完整引用证明
`runtime_scope.py` 的 principal 世代、`receipt.py` 审计回执、`skill_hub_cas.py` 项目锁和 maintenance 回滚代没有统一完备的租约/引用登记；仅按年龄或未发现引用删除会损失读取或审计能力。`cache status/prune` 暴露不确定原因并保留这些资产。
退出条件：由各 writer/reader 共用可验证的退休、审计释放和完整锁可达性合同，覆盖并发、离线项目及合法回滚后，再开放对应 GC；不以新清理命令的存在当作债务关闭。
...
- **R2-08 第一环（SQL 注册读取单元）**：`sql.catalog` 改从 Workspace 读取注册定义与 App，执行侧复用其读取 owner；词法匹配直接依赖既有 `agents.query_match`。切断 `sql.catalog → sql` 和 `sql.catalog → find`，原 20 模块环拆为 15/4/1（含单点），AST-only 最大环降到 17；eager 为 0，canonical 最大环仍为 555。查询、验证与公共 facade 保留，不以新增延迟 import 或 shim 降数。
...
```json
{"definition_id":"gravity-insight-runtime-possible-module-dependency-graph.v1","definition_sha256":"b3e0b2a61cb32c8069acec07315c1c65b94a3506c05133c7878a7a2c967f6326","edge_kind_counts":{"ast_delayed_import":520,"ast_eager_import":2716,"lazy_export_owner":62,"package_parent":717},"node_count":718,"profiles":{"ast+lazy-exports":{"cyclic_scc_count":4,"cyclic_scc_sha256":"7eaba3f3f80ba86a30c98d3d8b631c7ca2d05cf2e92eeeb89712e418d85f7140","cyclic_scc_sizes":[438,3,2,2],"edge_count":3275,"graph_sha256":"72ebc8d5e198c763a0102aa5da96a89e1e5e5b96e6f56e3cd63babcc002468d5","largest_cyclic_scc_size":438,"self_loop_scc_count":0},"ast-only":{"cyclic_scc_count":20,"cyclic_scc_sha256":"c059bc0105e078414027861ae456693d58e7624a9e4471851dab31f8ad7ae6f0","cyclic_scc_sizes":[17,15,11,8,6,4,3,3,3,3,2,2,2,2,2,2,2,2,2,1],"edge_count":3213,"graph_sha256":"8e7f9dd3734354a9b7f3c5541b1d9cb856dca9a5a999e41be3e4a7ac8d815244","largest_cyclic_scc_size":17,"self_loop_scc_count":1},"canonical":{"cyclic_scc_count":7,"cyclic_scc_sha256":"a0e86f9b1792a8c39edaa9decd88b6595d95e992b4d17480d37e2378923cc25c","cyclic_scc_sizes":[555,15,8,3,2,2,2],"edge_count":3907,"graph_sha256":"69a2187e6cb7a0ccb39675613d5b99dbe7bf67c37c86ebd6ef8d97ed12bea98e","largest_cyclic_scc_size":555,"self_loop_scc_count":0},"eager-ast-only":{"cyclic_scc_count":0,"cyclic_scc_sha256":"4f53cda18c2baa0c0354bb5f9a3ecbe5ed12ab4d8e11ba873c2f11161202b945","cyclic_scc_sizes":[],"edge_count":2716,"graph_sha256":"e11066df5c751d68204f3f8e1e6a6c696955315b24e69b3266ea23825107f7de","largest_cyclic_scc_size":0,"self_loop_scc_count":0}}}
```
