...
这些短指南从完整 Agent 产品卡、Analysis Spec、workspace 语义、错误合同和 manifest 生成；不创建 Skill 注册表，也不替代运行时合同。当前输入源包含 233 个 operation、93 张产品卡与 7 个精确 gap。
这些短指南从完整 Agent 产品卡、Analysis Spec、workspace 语义、错误合同和 manifest 生成；不创建 Skill 注册表，也不替代运行时合同。当前输入源包含 235 个 operation、92 张产品卡与 7 个精确 gap。
