...
- [Plan 面：agent 能不能自己搭一条多步分析并跑完](plan-surface.md) — 2026-08-19：4 节点 Plan 在投放中 App 上 4/4 success；`plan schema` 写出 analysis_query 绑定合同；`fetch_strategy` 死名已在 #212 修过。
