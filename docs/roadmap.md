...
7. **R07-R11 Runtime 基础；R12-A Action Plan（fixed-dev）**：exact-detail Segment metadata connector 已绑定双 user authorization、scope/preimage/owner/fields/expiry、一次性 plan+field claim 与 uncertain readback；R12-B/C 尚未启动。
