...
7. **R07-R12 Runtime、PAP、Action/Receipt/Experiment handoff（fixed-dev）**：Action 闭合双授权/readback，Receipt v1 增加值无关 facets，Experiment 只到 review/handoff；独立 Outcome Journey 因 power/significance Operator 缺失保持 blocked，不创建实验或自证结果。
