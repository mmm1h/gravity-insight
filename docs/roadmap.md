...
7. **R07-R15、CT01（fixed-dev）；CT02 ThinkingAI Representative Skills（in progress）**：五个独立作者代表项正验证 Capability/Semantic/Operator/Context/Model 依赖形态与 Team Hub exact lock；不复制第三方正文或营销结果。
