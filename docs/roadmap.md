...
7. **R07-R15、CT01-CT02（fixed-dev）；CT03 ThinkingAI Full Specification（in progress）**：正在以 5 个既有代表包、35 个新增独立规格和 15 个安全替代闭合当前 CT01 snapshot；readiness/validation 只按现有证据派生。
