...
| `external-method-library` | `stable` | vendor-neutral Skill library and isolated Source Registry | [CT01](CT01-external-method-inventory.md), [CT02](CT02-skill-library-validation.md), [CT03](CT03-skill-library-specification.md), [CT04](CT04-agent-skill-distribution.md) |
