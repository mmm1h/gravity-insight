...
| [R14](R14-adaptive-governor-variants.md) | Adaptive Governor and Execution Variants | R02 | `in_progress` (A fixed, B active; C/D specified) | Staged epic A→B, C, then D |
