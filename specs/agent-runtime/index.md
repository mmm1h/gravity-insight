...
| [R14](R14-adaptive-governor-variants.md) | Adaptive Governor and Execution Variants | R02 | `in_progress` (A/B fixed, C active; D specified) | Staged epic A→B, C, then D |
